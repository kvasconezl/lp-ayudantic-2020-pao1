...
INSERT INTO `tutorias` (`id`, `user_id`, `tutor_id`, `type`, `created_at`, `updated_at`)
VALUES (1, 1, 2, 0, '2020-09-16 04:40:24', '2020-09-16 04:40:24');
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `isTutor`, `remember_token`, `created_at`,
                     `updated_at`)
VALUES (1, 'Carlos', 'carfmeza@espol.edu.ec', NULL, '$2y$10$.kvHICz5jZNZHW7EsAYQu.vACX4meNzzZ5IrlQQTFs1asgZv4hB3S', 0,
        NULL, '2020-09-01 09:28:38', '2020-09-01 09:28:38'),
       (2, 'Tutor', 'tutor@company.com', NULL, '$2y$10$ve/RtGV6USmyyg9pS7ofBeb/1U8Wxi9Ca4eAv2.Ql5RgIs.xTyYcO', 1, NULL,
        '2020-09-01 09:30:08', '2020-09-01 09:30:08'),
       (3, 'Kevin', 'kvasconezl@espol.edu.ec', NULL, '$2y$10$X1Xi4e/UT9t33uCfh6oUF.9fkIATnVsqQowBGeBB0Q1lrJj1zJdxu', 0,
        NULL, '2020-09-01 09:30:41', '2020-09-01 09:30:41');
